 ...
 */
package com.olq.mytotal.bookview;
...
import com.myolq.frame.utils.DensityUtils;
import com.myolq.frame.utils.FileUtils;
import com.myolq.frame.utils.ScreenUtils;
import com.olq.mytotal.R;
import com.olq.mytotal.base.Constant;
import com.olq.mytotal.bean.BookMixAToc;
...
public class PageFactory {
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
        ...
        mNumFontSize = DensityUtils.dp2px(AppUtils.getAppContext(),16);
        marginWidth = DensityUtils.dp2px(AppUtils.getAppContext(),15);
        marginHeight = DensityUtils.dp2px(AppUtils.getAppContext(),15);
    ...
    public File getBookFile(int chapter) {
        File file = FileUtils.getChapterFile(Constant.PATH_DATA,bookId, chapter);
        ...
        if (mLines.size() > 0) {
            ...
            if (batteryBitmap != null) {
                canvas.drawBitmap(batteryBitmap, marginWidth + 2,
                        mHeight - marginHeight - DensityUtils.dp2px(AppUtils.getAppContext(),12), mTitlePaint);
            }
...
//        LogUtils.i("fontSize=" + fontsize);
    ...
    public void convertBetteryBitmap() {
        ...
        batteryView.measure(View.MeasureSpec.makeMeasureSpec(DensityUtils.dp2px(AppUtils.getAppContext(),26), View.MeasureSpec.EXACTLY),
                View.MeasureSpec.makeMeasureSpec(DensityUtils.dp2px(AppUtils.getAppContext(),14), View.MeasureSpec.EXACTLY));
