...
public class ThemeManager {
    ...
    public static Bitmap getThemeDrawable(int theme) {
        Bitmap bmp = Bitmap.createBitmap(ScreenUtils.getScreenWidth(AppUtils.getAppContext()), ScreenUtils.getScreenHeight(AppUtils.getAppContext()), Bitmap.Config.ARGB_8888);
        switch (theme) {
            case NORMAL:
